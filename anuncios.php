            ...
            <div class="contenedor-anuncios">
                ...
                <div class="anuncio">
                    <picture>
                        ...
                        <source src="build/img/anuncio4.jpg" type="image/webp">
                        <img loading="lazy" src="build/img/anuncio4.jpg" alt="imagen" >
                    </picture>
                    <div class="contenido-anuncio">
                        <h3> Casa con Alberca</h3>
                        <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
                ...
                <div class="anuncio">
                    <picture>
                        ...
                        <source src="build/img/anuncio5.jpg" type="image/webp">
                        <img loading="lazy" src="build/img/anuncio5.jpg" alt="imagen" >
                    </picture>
                    <div class="contenido-anuncio">
                        <h3> Casa con Alberca</h3>
                        <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
                ...
                <div class="anuncio">
                    <picture>
                        ...
                        <source src="build/img/anuncio6.jpg" type="image/webp">
                        <img loading="lazy" src="build/img/anuncio6.jpg" alt="imagen" >
                    </picture>
                    <div class="contenido-anuncio">
                        <h3> Casa con Alberca</h3>
                        <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
